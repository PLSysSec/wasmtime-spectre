...
// add rax, [r15 - 4096 + 888]
// add rcx, [r15 - 4096 + 888]
// add rdx, [r15 - 4096 + 888]
// add rbx, [r15 - 4096 + 888]
// add rsp, [r15 - 4096 + 888]
// add rbp, [r15 - 4096 + 888]
// add rsi, [r15 - 4096 + 888]
// add rdi, [r15 - 4096 + 888]
// add r8 , [r15 - 4096 + 888]
// add r9 , [r15 - 4096 + 888]
// add r10, [r15 - 4096 + 888]
// add r11, [r15 - 4096 + 888]
// add r12, [r15 - 4096 + 888]
// add r13, [r15 - 4096 + 888]
// add r14, [r15 - 4096 + 888]
// add r15, [r15 - 4096 + 888]
pub fn get_add_heapzero_bytes(reg: u16) -> &'static [u8] {
    match reg {
        R_RAX => &[0x49, 0x03, 0x87, 0x78, 0xf3, 0xff, 0xff],
        R_RCX => &[0x49, 0x03, 0x8f, 0x78, 0xf3, 0xff, 0xff],
        R_RDX => &[0x49, 0x03, 0x97, 0x78, 0xf3, 0xff, 0xff],
        R_RBX => &[0x49, 0x03, 0x9f, 0x78, 0xf3, 0xff, 0xff],
        R_RSP => &[0x49, 0x03, 0xa7, 0x78, 0xf3, 0xff, 0xff],
        R_RBP => &[0x49, 0x03, 0xaf, 0x78, 0xf3, 0xff, 0xff],
        R_RSI => &[0x49, 0x03, 0xb7, 0x78, 0xf3, 0xff, 0xff],
        R_RDI => &[0x49, 0x03, 0xbf, 0x78, 0xf3, 0xff, 0xff],
        R_R8  => &[0x4d, 0x03, 0x87, 0x78, 0xf3, 0xff, 0xff],
        R_R9  => &[0x4d, 0x03, 0x8f, 0x78, 0xf3, 0xff, 0xff],
        R_R10 => &[0x4d, 0x03, 0x97, 0x78, 0xf3, 0xff, 0xff],
        R_R11 => &[0x4d, 0x03, 0x9f, 0x78, 0xf3, 0xff, 0xff],
        R_R12 => &[0x4d, 0x03, 0xa7, 0x78, 0xf3, 0xff, 0xff],
        R_R13 => &[0x4d, 0x03, 0xaf, 0x78, 0xf3, 0xff, 0xff],
        R_R14 => &[0x4d, 0x03, 0xb7, 0x78, 0xf3, 0xff, 0xff],
        R_R15 => &[0x4d, 0x03, 0xbf, 0x78, 0xf3, 0xff, 0xff],
        _ => panic!("Unknown reg:{}", reg),
    }
}
