...
// offset of zero from heap base
// 4096 + (128 * 1024) + 4096 + 4096 − 888 = 142472
//
// add rax, [r15 - 142472]
// add rcx, [r15 - 142472]
// add rdx, [r15 - 142472]
...
pub fn get_add_heapzero_bytes(reg: u16) -> &'static [u8] {
    match reg {
        R_RAX => &[0x49, 0x03, 0x87, 0x78, 0xd3, 0xfd, 0xff],
        R_RCX => &[0x49, 0x03, 0x8f, 0x78, 0xd3, 0xfd, 0xff],
        R_RDX => &[0x49, 0x03, 0x97, 0x78, 0xd3, 0xfd, 0xff],
        R_RBX => &[0x49, 0x03, 0x9f, 0x78, 0xd3, 0xfd, 0xff],
        R_RSP => &[0x49, 0x03, 0xa7, 0x78, 0xd3, 0xfd, 0xff],
        R_RBP => &[0x49, 0x03, 0xaf, 0x78, 0xd3, 0xfd, 0xff],
        R_RSI => &[0x49, 0x03, 0xb7, 0x78, 0xd3, 0xfd, 0xff],
        R_RDI => &[0x49, 0x03, 0xbf, 0x78, 0xd3, 0xfd, 0xff],
        R_R8  => &[0x4d, 0x03, 0x87, 0x78, 0xd3, 0xfd, 0xff],
        R_R9  => &[0x4d, 0x03, 0x8f, 0x78, 0xd3, 0xfd, 0xff],
        R_R10 => &[0x4d, 0x03, 0x97, 0x78, 0xd3, 0xfd, 0xff],
        R_R11 => &[0x4d, 0x03, 0x9f, 0x78, 0xd3, 0xfd, 0xff],
        R_R12 => &[0x4d, 0x03, 0xa7, 0x78, 0xd3, 0xfd, 0xff],
        R_R13 => &[0x4d, 0x03, 0xaf, 0x78, 0xd3, 0xfd, 0xff],
        R_R14 => &[0x4d, 0x03, 0xb7, 0x78, 0xd3, 0xfd, 0xff],
        R_R15 => &[0x4d, 0x03, 0xbf, 0x78, 0xd3, 0xfd, 0xff],
        _ => panic!("Unknown reg:{}", reg),
    }
}
